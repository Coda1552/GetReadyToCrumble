...
public class GRTCEntities {
    ...
    public static final RegistryObject<EntityType<GrandmaEntity>> GRANDMA = create("grandma", EntityType.Builder.of(GrandmaEntity::new, MobCategory.CREATURE).sized(1.8f, 2.2f));
